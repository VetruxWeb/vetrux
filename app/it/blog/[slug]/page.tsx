...
export default async function ArticlePage({
  ...
  // Try database first
  const dbArticle = await getArticleBySlugFromDb(slug, 'it').catch(() => null);
  ...
  if (dbArticle) {
    ...
    return (
      <>
        ...
        <ArticlePageClient meta={meta} content={dbArticle.translation.content} locale="it" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <ArticlePageClient meta={article.meta} content={article.content} locale="it" />
    </>
  );
}
