...
export default async function ArticlePage({
  ...
  // Try database first
  const dbArticle = await getArticleBySlugFromDb(slug, 'ja').catch(() => null);
  ...
  if (dbArticle) {
    ...
    return (
      <>
        ...
        <ArticlePageClient meta={meta} content={dbArticle.translation.content} locale="ja" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <ArticlePageClient meta={article.meta} content={article.content} locale="ja" />
    </>
  );
}
