...
export default async function ArticlePage({
  ...
  // Try database first
  const dbArticle = await getArticleBySlugFromDb(slug, 'pt').catch(() => null);
  ...
  if (dbArticle) {
    ...
    return (
      <>
        ...
        <ArticlePageClient meta={meta} content={dbArticle.translation.content} locale="pt" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <ArticlePageClient meta={article.meta} content={article.content} locale="pt" />
    </>
  );
}
