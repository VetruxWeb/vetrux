...
export default async function ArticlePage({
  ...
  // Try database first
  const dbArticle = await getArticleBySlugFromDb(slug, 'fi').catch(() => null);
  ...
  if (dbArticle) {
    ...
    return (
      <>
        ...
        <ArticlePageClient meta={meta} content={dbArticle.translation.content} locale="fi" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <ArticlePageClient meta={article.meta} content={article.content} locale="fi" />
    </>
  );
}
