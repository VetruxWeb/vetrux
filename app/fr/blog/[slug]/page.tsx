...
export default async function ArticlePage({
  ...
  // Try database first
  const dbArticle = await getArticleBySlugFromDb(slug, 'fr').catch(() => null);
  ...
  if (dbArticle) {
    ...
    return (
      <>
        ...
        <ArticlePageClient meta={meta} content={dbArticle.translation.content} locale="fr" />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <ArticlePageClient meta={article.meta} content={article.content} locale="fr" />
    </>
  );
}
