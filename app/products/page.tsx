...
export default async function ProductsPage() {
  const products = await getAllProducts('en').catch(() => [])
    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-on-surface-variant">
          High-purity CBD products manufactured in our Chuxiong facility with full traceability and export-ready documentation.
        </p>
      </div>
