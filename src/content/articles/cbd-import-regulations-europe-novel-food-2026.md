...
<!-- flow-start: title="EU Novel Food Authorization Process" -->
<!-- step: label="Pre-submission" desc="Prepare dossier: safety data, specifications, manufacturing process" -->
<!-- step: label="Application Filing" desc="Submit to EU Commission via e-submission portal" -->
<!-- step: label="EFSA Assessment" desc="Scientific evaluation (9-month target, often longer)" -->
<!-- step: label="Risk Management" desc="Commission + member states review EFSA opinion" -->
<!-- step: label="Authorization" desc="Published in Official Journal; added to Union List" -->
<!-- flow-end -->
...
<!-- flow-start: title="EU CBD Import Documentation Checklist" -->
<!-- step: label="Origin Documents" desc="Certificate of Origin, export license, phytosanitary cert" -->
<!-- step: label="Quality Documents" desc="COA, GMP certificate, stability data" -->
<!-- step: label="Compliance Documents" desc="THC certificate, hemp variety proof, Novel Food status" -->
<!-- step: label="Customs Documents" desc="Commercial invoice, packing list, HS classification ruling" -->
<!-- step: label="Regulatory Documents" desc="REACH pre-registration, import permit (if required)" -->
<!-- flow-end -->

**Essential documents for EU CBD import:**
...
**Advantages:** Fastest market entry, clear regulatory pathway, no Novel Food uncertainty
**Limitations:** Cannot make ingestible product claims, limited to topical application
...
**Advantages:** Full market access once authorized, competitive moat against non-compliant competitors
**Limitations:** High cost (€500K–€2M), long timeline, uncertain outcome
...
**Advantages:** Avoids direct Novel Food obligation, serves multiple market segments
**Limitations:** Dependent on customer compliance; market limited to non-food applications without Novel Food authorization
...
[Vetrux](/about) provides EU-focused B2B buyers with:
...
For a detailed quotation and compliance documentation package, [contact our EU sales team](/inquiry).
...
### Do I need Novel Food authorization to import CBD isolate into the EU?
...
### What THC level is acceptable for CBD products in the EU?
...
### How long does the Novel Food authorization process take?
...
### What happens if my CBD shipment is stopped at EU customs?
...
### Can I sell CBD food products in the EU without Novel Food authorization?
...
### What is the difference between EU and UK CBD regulations post-Brexit?
...
### How does REACH affect CBD imports into the EU?
